...
class RegistrationViewController: UIViewController, UIPickerViewDataSource, UIImagePickerControllerDelegate, UINavigationControllerDelegate,UIPickerViewDelegate,UITextFieldDelegate {
    ...
    @IBAction func btnRegister_Click(sender: AnyObject) {
        ...
        else
        {
            ...
            self.saveUser(self.txtLastname.text!, firstname: txtFirstname.text!, email: txtEmail.text!, isTourist:isTourist, phone:txtPhone.text!,nationality:txtNationality.text!,language:txtViewLanguage.text!,pw:txtPW.text!)
        }
    }
...
//        txtNationality.inputView = pickerView
    ...
    func saveUser(lastname: String, firstname: String, email: String, isTourist:Bool, phone:String, nationality:String, language:String, pw:String) {
        ...
        var alert = UIAlertController(title: "Done", message:
            "Registration completed.", preferredStyle: UIAlertControllerStyle.Alert)
